...
class Ephemeris
{
    ...
    public static function trueNewMoon(int $k)
    {
        ...
        // 均值新月点
        $mnm = $jdt + 0.0001337 * $t2 - 1.5E-7 * $t3 + 7.3E-10 * $t4;
        ...
        // 因摄动造成的偏移
        $p1 = -0.4072 * sin((M_PI / 180) * $mprime);
        $p1 += 0.17241 * $es * sin((M_PI / 180) * $m);
        $p1 += 0.01608 * sin((M_PI / 180) * 2 * $mprime);
        $p1 += 0.01039 * sin((M_PI / 180) * 2 * $f);
        $p1 += 0.00739 * $es * sin((M_PI / 180) * ($mprime - $m));
        $p1 -= 0.00514 * $es * sin((M_PI / 180) * ($mprime + $m));
        $p1 += 0.00208 * $es * $es * sin((M_PI / 180) * (2 * $m));
        $p1 -= 0.00111 * sin((M_PI / 180) * ($mprime - 2 * $f));
        $p1 -= 0.00057 * sin((M_PI / 180) * ($mprime + 2 * $f));
        $p1 += 0.00056 * $es * sin((M_PI / 180) * (2 * $mprime + $m));
        $p1 -= 0.00042 * sin((M_PI / 180) * 3 * $mprime);
        $p1 += 0.00042 * $es * sin((M_PI / 180) * ($m + 2 * $f));
        $p1 += 0.00038 * $es * sin((M_PI / 180) * ($m - 2 * $f));
        $p1 -= 0.00024 * $es * sin((M_PI / 180) * (2 * $mprime - $m));
        $p1 -= 0.00017 * sin((M_PI / 180) * $omega);
        $p1 -= 0.00007 * sin((M_PI / 180) * ($mprime + 2 * $m));
        $p1 += 0.00004 * sin((M_PI / 180) * (2 * $mprime - 2 * $f));
        $p1 += 0.00004 * sin((M_PI / 180) * (3 * $m));
        $p1 += 0.00003 * sin((M_PI / 180) * ($mprime + $m - 2 * $f));
        $p1 += 0.00003 * sin((M_PI / 180) * (2 * $mprime + 2 * $f));
        $p1 -= 0.00003 * sin((M_PI / 180) * ($mprime + $m + 2 * $f));
        $p1 += 0.00003 * sin((M_PI / 180) * ($mprime - $m + 2 * $f));
        $p1 -= 0.00002 * sin((M_PI / 180) * ($mprime - $m - 2 * $f));
        $p1 -= 0.00002 * sin((M_PI / 180) * (3 * $mprime + $m));
        $p1 += 0.00002 * sin((M_PI / 180) * (4 * $mprime));

        $p2 = 0.000325 * sin((M_PI / 180) * (299.77 + 0.107408 * $k - 0.009173 * $t2));
        $p2 += 0.000165 * sin((M_PI / 180) * (251.88 + 0.016321 * $k));
        $p2 += 0.000164 * sin((M_PI / 180) * (251.83 + 26.651886 * $k));
        $p2 += 0.000126 * sin((M_PI / 180) * (349.42 + 36.412478 * $k));
        $p2 += 0.00011 * sin((M_PI / 180) * (84.66 + 18.206239 * $k));
        $p2 += 0.000062 * sin((M_PI / 180) * (141.74 + 53.303771 * $k));
        $p2 += 0.00006 * sin((M_PI / 180) * (207.14 + 2.453732 * $k));
        $p2 += 0.000056 * sin((M_PI / 180) * (154.84 + 7.30686 * $k));
        $p2 += 0.000047 * sin((M_PI / 180) * (34.52 + 27.261239 * $k));
        $p2 += 0.000042 * sin((M_PI / 180) * (207.19 + 0.121824 * $k));
        $p2 += 0.00004 * sin((M_PI / 180) * (291.34 + 1.844379 * $k));
        $p2 += 0.000037 * sin((M_PI / 180) * (161.72 + 24.198154 * $k));
        $p2 += 0.000035 * sin((M_PI / 180) * (239.56 + 25.513099 * $k));
        $p2 += 0.000023 * sin((M_PI / 180) * (331.55 + 3.592518 * $k));
